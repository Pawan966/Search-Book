...
public class ListActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<Book>>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUrlRequestGoogleBooks+=s;
        mUrlRequestGoogleBooks+="&maxResults=20";
        Log.i(LOG_TAG, "onCreate: "+ mUrlRequestGoogleBooks);
    ...
    public void onLoadFinished(Loader<List<Book>> loader, List<Book> books) {
        ...
        else mEmptyStateTextView.setText(R.string.no_books);
    }
